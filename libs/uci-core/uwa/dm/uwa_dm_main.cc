...
const tUWA_DM_ACTION uwa_dm_action[] = {
    ...
    uwa_dm_act_send_range_interval_update_request, /* UWA_DM_API_RANGE_INTERVAL_UPDATE_REQ_EVT */
    uwa_dm_act_send_app_data,           /* UWA_DM_API_APP_DATA_SEND_EVT     */
    uwa_dm_act_rcve_app_data,           /* UWA_DM_API_APP_DATA_RCVE_EVT     */
...
bool uwa_dm_evt_hdlr(UWB_HDR* p_msg) {
  ...
  UCI_TRACE_D(
      "event: %s (0x%02x)", uwa_dm_evt_2_str(event), event);
...
static const char * uwa_dm_evt_2_str(uint16_t event) {
  switch (UWA_SYS_EVT_START(UWA_ID_DM) | event) {
    ...
    case UWA_DM_API_RANGE_INTERVAL_UPDATE_REQ_EVT:
      return "UWA_DM_API_RANGE_INTERVAL_UPDATE_REQ_EVT";

    case UWA_DM_API_APP_DATA_SEND_EVT:
      return "UWA_DM_API_APP_DATA_SEND_EVT";

    case UWA_DM_API_APP_DATA_RCVE_EVT:
      return "UWA_DM_API_APP_DATA_RCVE_EVT";
