...
enum {
  ...
  UWA_DM_API_RANGE_INTERVAL_UPDATE_REQ_EVT,
  UWA_DM_API_APP_DATA_SEND_EVT,
  UWA_DM_API_APP_DATA_RCVE_EVT,
...
/* data type for UWA_DM_API_APP_DATA_SEND_EVT */
typedef struct {
  UWB_HDR hdr;
  uint32_t session_id;
  uint16_t dest_addr;
...
/* data type for UWA_DM_API_RANGE_INTERVAL_UPDATE_REQ_EVT */
typedef struct {
  UWB_HDR hdr;
  uint32_t session_id;  /* session_id for RCR */
  uint16_t interval;   /* RCR frame interval update */
} tUWA_DM_API_RANGE_INTERVAL_UPDATE_REQ;
...
typedef union {
  ...
  tUWA_DM_API_RANGE_INTERVAL_UPDATE_REQ  rangeIntervalUpdateReq; /* UWA_DM_API_RANGE_CTRL_REQ_EVT     */
  tUWA_DM_API_SEND_APP_DATA sApp_data_tx;           /* UWA_DM_API_APP_DATA_SEND_EVT    */
  tUWA_DM_API_RCVE_APP_DATA sApp_data_rx;           /* UWA_DM_API_APP_DATA_RCVE_EVT    */
