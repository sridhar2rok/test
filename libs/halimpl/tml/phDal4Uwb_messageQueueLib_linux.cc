...
**
*******************************************************************************/
intptr_t phDal4Uwb_msgget()
{
    phDal4Uwb_message_queue_t *pQueue;
    pQueue = (phDal4Uwb_message_queue_t *)malloc(sizeof(phDal4Uwb_message_queue_t));
    if (pQueue == NULL)
        return -1;
...
intptr_t phDal4Uwb_msgsnd(intptr_t msqid, phLibUwb_Message_t *msg, int msgflg)
{
    ...
    pQueue = (phDal4Uwb_message_queue_t *)msqid;
    pNew   = (phDal4Uwb_message_queue_item_t *)malloc(sizeof(phDal4Uwb_message_queue_item_t));
    if (pNew == NULL)
        return -1;
