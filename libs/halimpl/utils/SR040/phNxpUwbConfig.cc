...
const NxpParam_t phNxpUciHal_NXPConfig[] = {
    ...
    *FW log level for each above module
     ...
     * Disable : 0x00
     * Enable  : 0x01[default] */
    {UWB_MHR_IN_CCM, TYPE_VAL, CONFIG_VAL 0x01},
#endif
     ...
     * Enable  : 0x01 */
    {UWB_DDFS_TONE_CONFIG_ENABLE, TYPE_VAL, CONFIG_VAL 0x00},
#endif

#if UWBIOT_TML_SPI
    /* On Windows,
     * fall back to FW Defaults.  On QN9090, configure from here */
    /* Timeout for Firmware to enter DPD mode
     * Note: value set for UWB_DPD_ENTRY_TIMEOUT shall be in MilliSeconds.
     * Min : 100ms
     * Max : 2000ms */
    {UWB_DPD_ENTRY_TIMEOUT, TYPE_VAL, CONFIG_VAL 300},
    /* Firmware Low Power Mode
     * if UWB_LOW_POWER_MODE is 0, Firmware is Configured without Low Power Mode
