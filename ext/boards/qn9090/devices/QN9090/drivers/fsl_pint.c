 ...
 * retval None.
 */
void PINT_EnableCallbackByIndex(PINT_Type *base, pint_pin_int_t pintIdx, int priority)
{
    assert(base);
    ...
    NVIC_SetPriority(s_pintIRQ[pintIdx], priority); // Added by MK
